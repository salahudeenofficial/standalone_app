...
class BOFTDiff(WeightAdapterTrainBase):
...
class BOFTAdapter(WeightAdapterBase):
    ...
    @classmethod
    def load(cls, x: str, lora: dict[str, torch.Tensor], alpha: float, dora_scale: torch.Tensor) -> Optional["BOFTAdapter"]:
        # Placeholder implementation
        return None

    def to_train(self) -> WeightAdapterTrainBase:
        return BOFTDiff(self.weights)
