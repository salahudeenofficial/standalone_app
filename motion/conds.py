...
class CONDRegular:
    ...
    def process_cond(self, batch_size, **kwargs):
        return self._copy_with(motion.utils.repeat_to_batch_size(self.cond, batch_size))
...
class CONDNoiseShape(CONDRegular):
    def process_cond(self, batch_size, area, **kwargs):
        ...
        return self._copy_with(motion.utils.repeat_to_batch_size(data, batch_size))
...
class CONDList(CONDRegular):
    ...
    def process_cond(self, batch_size, **kwargs):
        out = []
        for c in self.cond:
            out.append(motion.utils.repeat_to_batch_size(c, batch_size))
