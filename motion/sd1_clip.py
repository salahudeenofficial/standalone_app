...
import traceback
import zipfile
from . import model_management_standalone as model_management
import motion.clip_models
import json
import logging
import numbers
import re
...
class SDClipModel(torch.nn.Module, ClipTokenWeightEncoder):
    ...
    def __init__(self, device="cpu", max_length=77,
                 freeze=True, layer="last", layer_idx=None, textmodel_json_config=None, dtype=None, model_class=motion.clip_models.CLIPTextModel,
