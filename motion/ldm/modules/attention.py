...
# Motion Pipeline Internal Dependencies
...
# Optional Attention Libraries (Gracefully Handled)
if xformers_enabled():
    import xformers
    import xformers.ops
...
# args and ops already imported above from motion pipeline equivalents

# FORCE_UPCAST_ATTENTION_DTYPE already defined above
...
def attention_sub_quad(query, key, value, heads, mask=None, attn_precision=None, skip_reshape=False, skip_output_reshape=False):
    ...
    mem_free_total, _ = get_free_memory(query.device, True)
...
if is_nvidia(): #pytorch 2.3 and up seem to have this issue.
