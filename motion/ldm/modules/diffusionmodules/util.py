# Standalone implementation of ComfyUI's diffusionmodules/util.py
# Motion Pipeline - ComfyUI Compatible Diffusion Utilities
# 
# adopted from
...
# Import from our standalone ldm_util module
import sys
import os
# Add motion directory to path for ldm_util import
motion_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
...
class AlphaBlender(nn.Module):
    ...
    def forward(
        ...
        # Ensure alpha has compatible shape with x_spatial
        while alpha.dim() < x_spatial.dim():
...
# Logging for module initialization
logging.info("Motion pipeline diffusion utilities loaded successfully")
