...
from ldm.flux.math import apply_rope
from ldm.common_dit import *
from model_management_standalone import *

# Motion Pipeline implementation of ComfyUI's wan/model.py
# Ready for manual copy-paste of ComfyUI code
...
class Head(nn.Module):
    ...
    def forward(self, x, e):
        ...
        if e.ndim < 3:
            ...
            e = (model_management.cast_to(self.modulation, dtype=x.dtype, device=x.device).unsqueeze(0) + e.unsqueeze(2)).unbind(2)
...
class WanModel(torch.nn.Module):
    ...
    def forward(self, x, timestep, context, clip_fea=None, time_dim_concat=None, transformer_options={}, **kwargs):
        bs, c, t, h, w = x.shape
        x = motion.ldm.common_dit.pad_to_patch_size(x, self.patch_size)
        ...
        if time_dim_concat is not None:
            time_dim_concat = motion.ldm.common_dit.pad_to_patch_size(time_dim_concat, self.patch_size)
